...
export class DatabaseResponseDto {
  @ApiProperty({
    ...
    example: 'I have generated a SQL query to find all users who signed up last month.',
  })
  response: string;
  ...
  @ApiProperty({
    description: 'The generated SQL query that can be executed to get the requested data',
    example:

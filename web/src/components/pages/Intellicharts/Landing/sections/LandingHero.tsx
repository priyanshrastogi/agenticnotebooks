      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="mb-6 max-w-5xl text-5xl font-bold leading-[1.1] tracking-tight md:text-6xl lg:text-7xl">
            Transform Any Data Into Beautiful Charts Instantly
          </h1>
          <p className="text-muted-foreground mt-6 max-w-2xl text-xl font-medium leading-relaxed">
            Feed any data source—JSON, CSV, APIs, XML, HTML—and watch our AI agent automatically
            parse, analyze, and create stunning, customizable charts in seconds.
          </p>
